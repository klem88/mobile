////////////////////////////
// VARIABLES
var dbname = 'mcegeps';//'mexecutive';//'dwhscholarvox';//'dwhbibliovox';//'mcegeps'
////////////////////////////
...
switch (dbname){
	...
	case 'mcegeps':
		homeentries = [
			{fr : "L'air du temps", en : 'ZeitGeist', id : 'zeitgeist'},
			{fr : 'Laissez vous guider', en : 'Need a hand?', id : 'decitre'}, 
			{fr : 'Le choix des Cegeps', en : "The Cegeps' choice", id : 'institutions'}, 
			{fr : 'Nouveautés éditeurs canadiens', en : "New Canadian Books", id : 'lastbookspub'}, 
			{fr : 'Mes étagères', en : 'My Shelves', id : 'myshelves'}, 
		];
		optid = {1 : 'decitre', 2 : 'institutions', 4 : 'lastbookspub'};
		platformurl = 'https://cegeps.scholarvox.com';
		defaultLang = 'fr';
		break;		
	default:
		homeentries = [];
